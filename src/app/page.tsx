            ...
            <div className="gold-footer-brand">
              ...
              <div className="gold-footer-socials">
                ...
                <a href={SITE_CONFIG.socials.snapchat.url} target="_blank" rel="noopener noreferrer" aria-label="Snapchat">
                  <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor"><path d="M12.2 1c.65.01 3.16.09 4.65 2.28.9 1.3 1.07 3.27 1.02 4.47v.06c.01.09.07.2.22.26.12.05.25.07.38.07.17 0 .34-.04.43-.08a.87.87 0 01.33-.07c.37 0 .75.24.75.58 0 .53-.93.86-1.34.99l-.07.02c-.2.07-.39.13-.44.2-.08.11-.01.31.03.45l.02.04c.52 1.27.99 1.87 1.69 2.13.25.1.44.14.6.18.29.07.49.12.49.39 0 .31-.39.5-.78.62-.13.04-.53.11-.57.12-.26.05-.48.13-.67.31-.22.2-.29.51-.33.69l-.01.03c-.02.13-.04.24-.17.24-.08 0-.2-.03-.36-.06a4.59 4.59 0 00-.96-.1c-.25 0-.48.02-.7.08-.4.1-.74.33-1.09.58-.63.43-1.33.92-2.68.95h-.07c-1.34-.03-2.05-.52-2.68-.95-.35-.25-.69-.48-1.09-.58a3.01 3.01 0 00-.7-.08c-.37 0-.7.06-.96.1-.16.03-.28.06-.36.06-.13 0-.15-.11-.17-.24l-.01-.03c-.04-.18-.1-.49-.33-.69-.18-.18-.41-.26-.67-.31-.04-.01-.44-.08-.57-.12-.39-.12-.78-.31-.78-.62 0-.27.2-.32.49-.39.16-.04.35-.08.6-.18.69-.26 1.17-.86 1.69-2.13l.02-.04c.04-.14.11-.34.03-.45-.05-.07-.24-.13-.44-.2l-.07-.02c-.41-.13-1.34-.46-1.34-.99 0-.34.38-.58.75-.58.12 0 .23.03.33.07.09.04.26.08.43.08.13 0 .26-.02.38-.07.15-.06.21-.17.22-.26v-.06c-.05-1.2.13-3.17 1.02-4.47C9.04 1.09 11.55 1.01 12.2 1z"/></svg>
                </a>
              </div>
            </div>
