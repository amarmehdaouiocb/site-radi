            ...
            <div className="gold-footer-brand">
              ...
              <div className="gold-footer-socials">
                ...
                <a href={SITE_CONFIG.socials.snapchat.url} target="_blank" rel="noopener noreferrer" aria-label="Snapchat">
                  <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M12 2c-2 0-4.2.6-5.2 3.2-.5 1.3-.5 3-.4 4.3-1-.2-2.3.1-2.3.9 0 .7.8 1 1.3 1.2-.7 1.8-2.1 2.4-2.1 3.2 0 .6.7.8 1.3 1 .5.1 1 .2 1.2.5.2.4.1.9.5 1.3.5.5 1.6.4 2.5.3.7-.1 1.5-.2 2.1.3.6.4 1 .9 1.9 1h.4c.9-.1 1.3-.6 1.9-1 .6-.5 1.4-.4 2.1-.3.9.1 2 .2 2.5-.3.4-.4.3-.9.5-1.3.2-.3.7-.4 1.2-.5.6-.2 1.3-.4 1.3-1 0-.8-1.4-1.4-2.1-3.2.5-.2 1.3-.5 1.3-1.2 0-.8-1.3-1.1-2.3-.9.1-1.3.1-3-.4-4.3C16.2 2.6 14 2 12 2z"/></svg>
                </a>
              </div>
            </div>
