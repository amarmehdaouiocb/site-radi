...
import Cards3DGallery from "@/components/galleries/Cards3DGallery";
import "../../../app/gold.css";
    ...
    <div className="gold-variant">
      ...
      <nav className="demo-nav">
        ...
        <div className="demo-nav-links">
          ...
          <Link href="/demo/cards-3d" className="active">Cards 3D</Link>
        </div>
      </nav>
      ...
      <div className="demo-hero">
        <h1>Demo: Cards 3D</h1>
        <p>Cartes empilées avec effet de profondeur et interaction</p>
      </div>
